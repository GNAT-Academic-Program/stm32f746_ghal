...
package STM32F746.STK is
   ...
   subtype CSR_ENABLE_Field is STM32F746.Bit;
   subtype CSR_TICKINT_Field is STM32F746.Bit;
   subtype CSR_CLKSOURCE_Field is STM32F746.Bit;
   subtype CSR_COUNTFLAG_Field is STM32F746.Bit;
   ...
   type CSR_Register is record
      ...
      --  unspecified
      Reserved_3_15  : STM32F746.UInt13 := 16#0#;
      --  COUNTFLAG
   ...
   subtype RVR_RELOAD_Field is STM32F746.UInt24;
   ...
   subtype CVR_CURRENT_Field is STM32F746.UInt24;
   ...
   subtype CALIB_TENMS_Field is STM32F746.UInt24;
   subtype CALIB_SKEW_Field is STM32F746.Bit;
   subtype CALIB_NOREF_Field is STM32F746.Bit;
   ...
   type CALIB_Register is record
      ...
      --  unspecified
      Reserved_24_29 : STM32F746.UInt6 := 16#0#;
