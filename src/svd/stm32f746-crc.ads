...
package STM32F746.CRC is
   ...
   subtype IDR_IDR_Field is STM32F746.Byte;
   ...
   subtype CR_CR_Field is STM32F746.Bit;
   ...
   type CRC_Peripheral is record
      ...
      --  Initial CRC value
      INIT : aliased STM32F746.UInt32;
      --  CRC polynomial
      POL  : aliased STM32F746.UInt32;
   end record
     with Volatile;
