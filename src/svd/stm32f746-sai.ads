...
package STM32F746.SAI is
   ...
   subtype GCR_SYNCIN_Field is STM32F746.UInt2;
   subtype GCR_SYNCOUT_Field is STM32F746.UInt2;
   ...
   subtype ACR1_MODE_Field is STM32F746.UInt2;
   subtype ACR1_PRTCFG_Field is STM32F746.UInt2;
   subtype ACR1_DS_Field is STM32F746.UInt3;
   subtype ACR1_LSBFIRST_Field is STM32F746.Bit;
   subtype ACR1_CKSTR_Field is STM32F746.Bit;
   subtype ACR1_SYNCEN_Field is STM32F746.UInt2;
   subtype ACR1_MONO_Field is STM32F746.Bit;
   subtype ACR1_OutDri_Field is STM32F746.Bit;
   subtype ACR1_SAIAEN_Field is STM32F746.Bit;
   subtype ACR1_DMAEN_Field is STM32F746.Bit;
   subtype ACR1_NODIV_Field is STM32F746.Bit;
   subtype ACR1_MCJDIV_Field is STM32F746.UInt4;
   ...
   type ACR1_Register is record
      ...
      --  unspecified
      Reserved_4_4   : STM32F746.Bit := 16#0#;
      --  Data size
      ...
      --  unspecified
      Reserved_14_15 : STM32F746.UInt2 := 16#0#;
   ...
   subtype ACR2_FTH_Field is STM32F746.UInt3;
   subtype ACR2_FFLUS_Field is STM32F746.Bit;
   subtype ACR2_TRIS_Field is STM32F746.Bit;
   subtype ACR2_MUTE_Field is STM32F746.Bit;
   subtype ACR2_MUTEVAL_Field is STM32F746.Bit;
   subtype ACR2_MUTECN_Field is STM32F746.UInt6;
   subtype ACR2_CPL_Field is STM32F746.Bit;
   subtype ACR2_COMP_Field is STM32F746.UInt2;
   ...
   subtype AFRCR_FRL_Field is STM32F746.Byte;
   subtype AFRCR_FSALL_Field is STM32F746.UInt7;
   subtype AFRCR_FSDEF_Field is STM32F746.Bit;
   subtype AFRCR_FSPOL_Field is STM32F746.Bit;
   subtype AFRCR_FSOFF_Field is STM32F746.Bit;
   ...
   subtype ASLOTR_FBOFF_Field is STM32F746.UInt5;
   subtype ASLOTR_SLOTSZ_Field is STM32F746.UInt2;
   subtype ASLOTR_NBSLOT_Field is STM32F746.UInt4;
   subtype ASLOTR_SLOTEN_Field is STM32F746.UInt16;
   ...
   subtype AIM_OVRUDRIE_Field is STM32F746.Bit;
   subtype AIM_MUTEDET_Field is STM32F746.Bit;
   subtype AIM_WCKCFG_Field is STM32F746.Bit;
   subtype AIM_FREQIE_Field is STM32F746.Bit;
   subtype AIM_CNRDYIE_Field is STM32F746.Bit;
   subtype AIM_AFSDETIE_Field is STM32F746.Bit;
   subtype AIM_LFSDET_Field is STM32F746.Bit;
   ...
   subtype ASR_OVRUDR_Field is STM32F746.Bit;
   subtype ASR_MUTEDET_Field is STM32F746.Bit;
   subtype ASR_WCKCFG_Field is STM32F746.Bit;
   subtype ASR_FREQ_Field is STM32F746.Bit;
   subtype ASR_CNRDY_Field is STM32F746.Bit;
   subtype ASR_AFSDET_Field is STM32F746.Bit;
   subtype ASR_LFSDET_Field is STM32F746.Bit;
   subtype ASR_FLVL_Field is STM32F746.UInt3;
   ...
   subtype ACLRFR_OVRUDR_Field is STM32F746.Bit;
   subtype ACLRFR_MUTEDET_Field is STM32F746.Bit;
   subtype ACLRFR_WCKCFG_Field is STM32F746.Bit;
   subtype ACLRFR_CNRDY_Field is STM32F746.Bit;
   subtype ACLRFR_CAFSDET_Field is STM32F746.Bit;
   subtype ACLRFR_LFSDET_Field is STM32F746.Bit;
   ...
   subtype BCR1_MODE_Field is STM32F746.UInt2;
   subtype BCR1_PRTCFG_Field is STM32F746.UInt2;
   subtype BCR1_DS_Field is STM32F746.UInt3;
   subtype BCR1_LSBFIRST_Field is STM32F746.Bit;
   subtype BCR1_CKSTR_Field is STM32F746.Bit;
   subtype BCR1_SYNCEN_Field is STM32F746.UInt2;
   subtype BCR1_MONO_Field is STM32F746.Bit;
   subtype BCR1_OutDri_Field is STM32F746.Bit;
   subtype BCR1_SAIBEN_Field is STM32F746.Bit;
   subtype BCR1_DMAEN_Field is STM32F746.Bit;
   subtype BCR1_NODIV_Field is STM32F746.Bit;
   subtype BCR1_MCJDIV_Field is STM32F746.UInt4;
   ...
   subtype BCR2_FTH_Field is STM32F746.UInt3;
   subtype BCR2_FFLUS_Field is STM32F746.Bit;
   subtype BCR2_TRIS_Field is STM32F746.Bit;
   subtype BCR2_MUTE_Field is STM32F746.Bit;
   subtype BCR2_MUTEVAL_Field is STM32F746.Bit;
   subtype BCR2_MUTECN_Field is STM32F746.UInt6;
   subtype BCR2_CPL_Field is STM32F746.Bit;
   subtype BCR2_COMP_Field is STM32F746.UInt2;
   ...
   subtype BFRCR_FRL_Field is STM32F746.Byte;
   subtype BFRCR_FSALL_Field is STM32F746.UInt7;
   subtype BFRCR_FSDEF_Field is STM32F746.Bit;
   subtype BFRCR_FSPOL_Field is STM32F746.Bit;
   subtype BFRCR_FSOFF_Field is STM32F746.Bit;
   ...
   subtype BSLOTR_FBOFF_Field is STM32F746.UInt5;
   subtype BSLOTR_SLOTSZ_Field is STM32F746.UInt2;
   subtype BSLOTR_NBSLOT_Field is STM32F746.UInt4;
   subtype BSLOTR_SLOTEN_Field is STM32F746.UInt16;
   ...
   subtype BIM_OVRUDRIE_Field is STM32F746.Bit;
   subtype BIM_MUTEDET_Field is STM32F746.Bit;
   subtype BIM_WCKCFG_Field is STM32F746.Bit;
   subtype BIM_FREQIE_Field is STM32F746.Bit;
   subtype BIM_CNRDYIE_Field is STM32F746.Bit;
   subtype BIM_AFSDETIE_Field is STM32F746.Bit;
   subtype BIM_LFSDETIE_Field is STM32F746.Bit;
   ...
   subtype BSR_OVRUDR_Field is STM32F746.Bit;
   subtype BSR_MUTEDET_Field is STM32F746.Bit;
   subtype BSR_WCKCFG_Field is STM32F746.Bit;
   subtype BSR_FREQ_Field is STM32F746.Bit;
   subtype BSR_CNRDY_Field is STM32F746.Bit;
   subtype BSR_AFSDET_Field is STM32F746.Bit;
   subtype BSR_LFSDET_Field is STM32F746.Bit;
   subtype BSR_FLVL_Field is STM32F746.UInt3;
   ...
   type BSR_Register is record
      ...
      --  unspecified
      Reserved_7_15  : STM32F746.UInt9;
      --  Read-only. FIFO level threshold
      FLVL           : BSR_FLVL_Field;
      --  unspecified
      Reserved_19_31 : STM32F746.UInt13;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   subtype BCLRFR_OVRUDR_Field is STM32F746.Bit;
   subtype BCLRFR_MUTEDET_Field is STM32F746.Bit;
   subtype BCLRFR_WCKCFG_Field is STM32F746.Bit;
   subtype BCLRFR_CNRDY_Field is STM32F746.Bit;
   subtype BCLRFR_CAFSDET_Field is STM32F746.Bit;
   subtype BCLRFR_LFSDET_Field is STM32F746.Bit;
