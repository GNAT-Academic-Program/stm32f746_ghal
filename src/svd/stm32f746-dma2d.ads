...
package STM32F746.DMA2D is
   ...
   subtype CR_START_Field is STM32F746.Bit;
   subtype CR_SUSP_Field is STM32F746.Bit;
   subtype CR_ABORT_Field is STM32F746.Bit;
   subtype CR_TEIE_Field is STM32F746.Bit;
   subtype CR_TCIE_Field is STM32F746.Bit;
   subtype CR_TWIE_Field is STM32F746.Bit;
   subtype CR_CAEIE_Field is STM32F746.Bit;
   subtype CR_CTCIE_Field is STM32F746.Bit;
   subtype CR_CEIE_Field is STM32F746.Bit;
   subtype CR_MODE_Field is STM32F746.UInt2;
   ...
   subtype ISR_TEIF_Field is STM32F746.Bit;
   subtype ISR_TCIF_Field is STM32F746.Bit;
   subtype ISR_TWIF_Field is STM32F746.Bit;
   subtype ISR_CAEIF_Field is STM32F746.Bit;
   subtype ISR_CTCIF_Field is STM32F746.Bit;
   subtype ISR_CEIF_Field is STM32F746.Bit;
   ...
   subtype IFCR_CTEIF_Field is STM32F746.Bit;
   subtype IFCR_CTCIF_Field is STM32F746.Bit;
   subtype IFCR_CTWIF_Field is STM32F746.Bit;
   subtype IFCR_CAECIF_Field is STM32F746.Bit;
   subtype IFCR_CCTCIF_Field is STM32F746.Bit;
   subtype IFCR_CCEIF_Field is STM32F746.Bit;
   ...
   subtype FGOR_LO_Field is STM32F746.UInt14;
   ...
   subtype BGOR_LO_Field is STM32F746.UInt14;
   ...
   subtype FGPFCCR_CM_Field is STM32F746.UInt4;
   subtype FGPFCCR_CCM_Field is STM32F746.Bit;
   subtype FGPFCCR_START_Field is STM32F746.Bit;
   subtype FGPFCCR_CS_Field is STM32F746.Byte;
   subtype FGPFCCR_AM_Field is STM32F746.UInt2;
   subtype FGPFCCR_ALPHA_Field is STM32F746.Byte;
   ...
   subtype FGCOLR_BLUE_Field is STM32F746.Byte;
   subtype FGCOLR_GREEN_Field is STM32F746.Byte;
   subtype FGCOLR_RED_Field is STM32F746.Byte;
   ...
   subtype BGPFCCR_CM_Field is STM32F746.UInt4;
   subtype BGPFCCR_CCM_Field is STM32F746.Bit;
   subtype BGPFCCR_START_Field is STM32F746.Bit;
   subtype BGPFCCR_CS_Field is STM32F746.Byte;
   subtype BGPFCCR_AM_Field is STM32F746.UInt2;
   subtype BGPFCCR_ALPHA_Field is STM32F746.Byte;
   ...
   subtype BGCOLR_BLUE_Field is STM32F746.Byte;
   subtype BGCOLR_GREEN_Field is STM32F746.Byte;
   subtype BGCOLR_RED_Field is STM32F746.Byte;
   ...
   subtype OPFCCR_CM_Field is STM32F746.UInt3;
   ...
   subtype OCOLR_BLUE_Field is STM32F746.Byte;
   subtype OCOLR_GREEN_Field is STM32F746.Byte;
   subtype OCOLR_RED_Field is STM32F746.Byte;
   subtype OCOLR_APLHA_Field is STM32F746.Byte;
   ...
   subtype OOR_LO_Field is STM32F746.UInt14;
   ...
   subtype NLR_NL_Field is STM32F746.UInt16;
   subtype NLR_PL_Field is STM32F746.UInt14;
   ...
   subtype LWR_LW_Field is STM32F746.UInt16;
   ...
   subtype AMTCR_EN_Field is STM32F746.Bit;
   subtype AMTCR_DT_Field is STM32F746.Byte;
   ...
   subtype FGCLUT_BLUE_Field is STM32F746.Byte;
   subtype FGCLUT_GREEN_Field is STM32F746.Byte;
   subtype FGCLUT_RED_Field is STM32F746.Byte;
   subtype FGCLUT_APLHA_Field is STM32F746.Byte;
   ...
   subtype BGCLUT_BLUE_Field is STM32F746.Byte;
   subtype BGCLUT_GREEN_Field is STM32F746.Byte;
   subtype BGCLUT_RED_Field is STM32F746.Byte;
   subtype BGCLUT_APLHA_Field is STM32F746.Byte;
   ...
   type DMA2D_Peripheral is record
      ...
      FGMAR   : aliased STM32F746.UInt32;
      --  foreground offset register
      FGOR    : aliased FGOR_Register;
      --  background memory address register
      BGMAR   : aliased STM32F746.UInt32;
      --  background offset register
