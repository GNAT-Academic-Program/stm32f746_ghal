...
package body STM32F746_SPI is
   ...
   is
      ...
      Divisor : Natural := 2;
   begin
      for BR in STM32F746.UInt3 loop
   ...
   begin
      return (Periph => STM32F746_SPI.Periph);
   end Make_Device;
   ...
   begin
      ...
      Dev.Periph.CR2.DS :=
        (case Cfg.Data_Size is
            when Spi_Types.Data_8  => STM32F746.UInt4 (7),
            when Spi_Types.Data_16 => STM32F746.UInt4 (15));
